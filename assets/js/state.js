...
let staff = JSON.parse(localStorage.getItem("LumShift_staff") || "null") || [
  { id: 1, name: "Amy", role: "全職", roleGroup: "general" },
  { id: 2, name: "Ben", role: "兼職", roleGroup: "general" },
  { id: 3, name: "Chia", role: "店長", roleGroup: "manager" },
  { id: 4, name: "Dora", role: "全職", roleGroup: "general" },
  { id: 5, name: "Eli", role: "工讀生", roleGroup: "general" },
];
let shifts = JSON.parse(localStorage.getItem("LumShift_shifts") || "null") || [
  {
    id: 0,
    name: "早班",
    start: "08:00",
...
let holidays =
  JSON.parse(localStorage.getItem("LumShift_holidays") || "null") || {};
let leaves =
...
function leavesForDate(date) {
  return leaves.filter((l) => l.date === date);
}
...
function getDaySchedule(date) {
  ...
  schedule[mk] = schedule[mk] || {};
  schedule[mk][date] = schedule[mk][date] || {};

  shifts.forEach((s) => {
    schedule[mk][date][s.id] = schedule[mk][date][s.id] || [];
  });
